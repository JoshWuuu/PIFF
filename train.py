...
def create_training_options():
    ...
    parser.add_argument("--name",           type=str,   default='piff_multi',        help="experiment ID")
    ...
    parser.add_argument("--testing-rainfall", type=list, default=[7, 24, 84, 85, 86], help="specify the rainfall for testing, e.g., --testing-rainfall 5 10 15")
    # --------------- optimizer and loss ---------------
